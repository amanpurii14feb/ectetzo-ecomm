...
export function VirtualProductGrid({
  ...
  const virtualizer = useWindowVirtualizer({
    count: rows.length,
    estimateSize: () => (view === "list" ? 286 : 410),
    overscan: 2,
    scrollMargin: layout.top,
    // React 19 cannot synchronously flush while ref/lifecycle measurements
    // are being committed. Schedule these updates normally instead.
    useFlushSync: false,
